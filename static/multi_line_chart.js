function makeLineChart(dataset, xName, yObjs, axisLables) {
    ...
    console.log("hello inside makelinechart js");
    console.log(dataset)
     d3 = d3version3;
    ...
    chartObj.margin = {top: 15, right: 60, bottom: 30, left: 95};
    var w = d3.select("#line1").node().getBoundingClientRect().width
    var h  = d3.select("#line1").node().getBoundingClientRect().height
    

    chartObj.width = w - chartObj.margin.left - chartObj.margin.right;
    chartObj.height = h - chartObj.margin.top - chartObj.margin.bottom;

// So we can pass the x and y as strings when creating the function
    chartObj.xFunct = function(d){return d[xName]};
    console.log(chartObj.xFunct(dataset))
...
// Change chart size according to window size
    ...
    chartObj.bind = function (selector) {
        ...
        chartObj.mainDiv.attr("width"," " + w + " ").attr("height"," " + h + " ") 
